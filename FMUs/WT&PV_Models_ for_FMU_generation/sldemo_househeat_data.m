...
datairradiance = readmatrix('4daysirradiance.csv');
datawindspeed = readmatrix('4dayswindspeed.csv');
datahumidity = readmatrix('4dayshumidity.csv');
datacurrent = readmatrix('sim_results.csv');